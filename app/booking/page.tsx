...
export default function BookingPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Phone number validation (checking if it contains valid digits/symbols)
    ...
    router.push("/"); // Back to home after submission
  };
      ...
      <div className="bg-white w-full max-w-2xl rounded-3xl p-6 md:p-8 shadow-2xl relative border border-slate-100 my-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            {/* Expected Start Date (No Past Dates Allowed) */}
            <div className="space-y-1">
